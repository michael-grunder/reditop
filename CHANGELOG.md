...
### Changed
- Detail tabs now render mnemonic labels (`[S]ummary`, `[L]atency`, `[I]nfo Raw`), highlight the active tab more strongly, and support direct keyboard jumps with `S`, `L`, and `I`.
